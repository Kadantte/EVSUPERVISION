...
<body>
<div class="main">
<div class="top-banner"><div class="container"><a href="${ctxPath}/manager/home"><img src="${ctxPath}/static/images/header.png" height="80"></a></div></div>
<div class="top-menu"></div>
<div class="main-wrapper">
    <c:if test="${param.error != null}">
        <div class="error">Votre nom ou mot de passe est incorrect</div>
    </c:if>
    <div class="content">
        <section><span>Se connecter</span></section>
        <form method="POST" action="${ctxPath}/manager/signin">
            <table class="userInput">
                <tr><td>Nom:</td><td><input type="text" name="username" id="username" required /></td></tr>
                <tr><td>Mot de passe:</td><td><input type="password" name="password" id="password" required /></td></tr>
